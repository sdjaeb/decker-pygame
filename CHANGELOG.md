...
- **run-audit**: add run playbook, sample-run capture, run instructions, and integration test
- **presentation**: instrument UI events with structured logging\n\nfeat(run): add sample run generator and run_logs; adapt asset loader formatting
